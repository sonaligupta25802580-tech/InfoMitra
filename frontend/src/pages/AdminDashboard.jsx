    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              />
              <h1 className="text-lg sm:text-2xl font-bold text-gray-800">InfoMitra Admin Panel</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="bg-white border-l-4 border-orange-500 p-6 mb-8 shadow">
          <h2 className="text-3xl font-bold text-gray-800">Administration Dashboard</h2>
          <p className="text-gray-600 mt-2">Manage users and government schemes</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white border-2 border-blue-200 rounded p-8 shadow-md">
                <div className="text-5xl mb-4 text-blue-600">👥</div>
                <h3 className="text-4xl font-bold text-gray-800 mb-2">{stats.total_users}</h3>
                <p className="text-gray-600 text-lg font-semibold">Total Registered Users</p>
              </div>

              <div className="bg-white border-2 border-green-200 rounded p-8 shadow-md">
                <div className="text-5xl mb-4 text-green-600">📋</div>
                <h3 className="text-4xl font-bold text-gray-800 mb-2">{stats.total_schemes}</h3>
                <p className="text-gray-600 text-lg font-semibold">Total Government Schemes</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-800">Manage Schemes</h3>
                <p className="text-sm text-gray-600">Create, edit, and delete schemes</p>
              </button>
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-800">Marquee Settings</h3>
                <p className="text-sm text-gray-600">Edit scrolling banner message and new scheme visibility</p>
              </button>
            </div>
          </>
        )}
